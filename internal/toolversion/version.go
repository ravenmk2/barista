// Package toolversion parses and compares dotted numeric versions with an
// optional qualifier (4.0.0-rc-4), shared by the tool domains (maven, gradle).
package toolversion
...
func Parse(s string) (segs []int, qualifier string, err error) {
