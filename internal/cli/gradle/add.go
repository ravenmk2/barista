...
func addCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "add <path>",
		Short: "Register an installed Gradle (reads the version from lib/gradle-core-*.jar)",
	...
	cmd.Flags().String("name", "", "register under this name (default: gradle-<version> from the probed version)")
	cmd.Flags().Bool("default", false, "set as the default gradle")
	return cmd
}
