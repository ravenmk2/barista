...
const (
	...
	CodeNodeProbeFailed         = "NODE_PROBE_FAILED"
	CodeNodeDownloadFailed      = "NODE_DOWNLOAD_FAILED"
	CodeNodeChecksumMismatch    = "NODE_CHECKSUM_MISMATCH"
	CodeNodeInstallFailed       = "NODE_INSTALL_FAILED"
	CodeNodeNotManaged          = "NODE_NOT_MANAGED"
